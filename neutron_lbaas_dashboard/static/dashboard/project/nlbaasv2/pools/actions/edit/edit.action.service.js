...
(function() {
  ...
  angular
    ...
    .factory('horizon.dashboard.project.nlbaasv2.pools.actions.edit', editService);
  ...
  /**
   * @ngDoc factory
   * @name horizon.dashboard.project.nlbaasv2.listeners.actions.editService
   * @description
  ...
  function editService(
    ...
    var edit = workflowModal.init({
      controller: 'nLBaaSEditPoolWizardController',
