...
(function() {
  ...
  angular
    ...
    .factory('horizon.dashboard.project.nlbaasv2.pools.actions.rowActions',
      rowActions);

  rowActions.$inject = [
    'horizon.framework.util.i18n.gettext',
    'horizon.dashboard.project.nlbaasv2.loadbalancers.service',
    'horizon.dashboard.project.nlbaasv2.pools.actions.edit',
    'horizon.dashboard.project.nlbaasv2.pools.actions.delete',
    'horizon.dashboard.project.nlbaasv2.healthmonitors.actions.create'
  ];

  /**
   * @ngdoc service
   * @ngname horizon.dashboard.project.nlbaasv2.pools.actions.rowActions
   *
   * @description
