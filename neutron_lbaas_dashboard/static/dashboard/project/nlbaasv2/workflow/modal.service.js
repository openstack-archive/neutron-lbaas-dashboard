...
(function() {
  ...
  angular
    ...
    .factory('horizon.dashboard.project.nlbaasv2.workflow.modal', modalService);
  ...
  /**
   * @ngdoc service
   * @ngname horizon.dashboard.project.nlbaasv2.workflow.modal
   *
   * @description
    ...
    function init(args) {
      ...
      function open(item) {
        var spec = {
          ...
          template: '<wizard class="wizard nlbaas-wizard" ng-controller="' +
