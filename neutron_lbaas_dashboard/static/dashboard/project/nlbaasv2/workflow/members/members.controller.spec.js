...
(function() {
  ...
  describe('Member Details Step', function() {
    ...
    describe('nLBaaSMemberDetailsController', function() {
      var ctrl;

      beforeEach(inject(function($controller) {
        ctrl = $controller('nLBaaSMemberDetailsController', { $scope: { model: model } });
      }));
    ...
    describe('Member Details Step Template', function() {
      ...
      beforeEach(inject(function($injector) {
        ...
        var basePath = $injector.get('horizon.dashboard.project.nlbaasv2.basePath');
        var popoverTemplates = $injector.get('horizon.dashboard.project.nlbaasv2.popovers');
