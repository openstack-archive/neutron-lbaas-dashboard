...
(function () {
  ...
  angular
    ...
    .controller('nLBaaSMemberDetailsController', MemberDetailsController);

  MemberDetailsController.$inject = [
    '$scope',
    '$compile',
    'horizon.dashboard.project.nlbaasv2.popovers',
    'horizon.dashboard.project.nlbaasv2.patterns',
